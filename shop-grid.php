...
$showData = $show("product");
$amountProduct = $conn->query("SELECT COUNT(*) AS amount FROM product");
$result = $amountProduct->fetch_assoc();
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg"
                                        data-setbg="img/product/<?= $row['product_image'] ?>">
